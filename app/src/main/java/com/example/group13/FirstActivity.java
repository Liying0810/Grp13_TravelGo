...
public class FirstActivity extends AppCompatActivity {
    ...
    ImageView back_arrow, second_arrow_up;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        more_details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(FirstActivity.this, First_Details_Activity.class);
        ...
        //Set Animations
        back_arrow.setAnimation(from_left);
        ...
        second_arrow_up.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(FirstActivity.this, com.example.group13.First_Details_Activity.class);
